...
namespace CharacterCustomizationTool.Editor.Character
{
    ...
    {
        private static readonly SlotType[] AlwaysEnabledParts = { SlotType.Body, };
        ...
        {
            _characterGameObject = BaseMeshAccessor.Load();
        ...
        public SlotBase GetSlotBy(SlotType slotType)
        {
